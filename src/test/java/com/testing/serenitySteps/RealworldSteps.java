...
public class RealworldSteps extends BaseSteps {
    ...
    @Step
    public static void modifies(DataTable dataTable) throws IOException {
    ...
    public static void createComment(DataTable dataTable) throws IOException {
        sendRequestWithBodyJson(PUT, _API_ARTICLES_ + sessionVariableCalled("slug") + "/comments", createBody(dataTable));
